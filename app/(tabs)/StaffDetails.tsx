...
//                 role: staffDetails.staff.role || 'staff'
//       });
//     }
//   }, [staffDetails]);
    ...
    <ScrollView className="flex-1 bg-[#0A0F1E] p-4 pt-14">
      ...
      <View className="bg-gray-800 rounded-xl p-6 mb-6">
        <View className="flex-row items-center mb-4">
          ...
          <View className="flex-1">
            ...
            <Text className="text-gray-400 text-sm mt-1">Role: {staff.role || 'staff'}</Text>
          </View>
        </View>
      ...
      <View className="bg-gray-800 rounded-xl p-6 mb-6">
        ...
        <View className="flex-row flex-wrap justify-between gap-4">
          <View className="bg-gray-700 p-4 rounded-lg flex-1 min-w-[45%]">
            <Text className="text-white text-lg font-semibold">{monthlyStats?.totalServices || 0}</Text>
            <Text className="text-gray-400 text-sm">Services Completed</Text>
          </View>
          <View className="bg-gray-700 p-4 rounded-lg flex-1 min-w-[45%]">
            <Text className="text-green-400 text-lg font-semibold">{formatCurrency(monthlyStats?.totalRevenue || 0)}</Text>
            <Text className="text-gray-400 text-sm">Revenue Generated</Text>
          </View>
          <View className="bg-gray-700 p-4 rounded-lg flex-1 min-w-[45%]">
            <Text className="text-blue-400 text-lg font-semibold">{monthlyStats?.completedAppointments || 0}</Text>
            <Text className="text-gray-400 text-sm">Completed Appointments</Text>
          </View>
          <View className="bg-gray-700 p-4 rounded-lg flex-1 min-w-[45%]">
            <Text className="text-yellow-400 text-lg font-semibold">{monthlyStats?.pendingAppointments || 0}</Text>
            <Text className="text-gray-400 text-sm">Pending Appointments</Text>
          </View>
        </View>
      </View>
